...
class TrainConfig:
    ...
    use_packing: bool = False  # Backward-compatible alias for pack_sequences.
    ...
    # Options: "ddp" (default) or "fsdp2".
    distributed_backend: str = "ddp"
    # FSDP2 options (only used when distributed_backend == "fsdp2").
    fsdp2_reshard_after_forward: bool = True
    fsdp2_mixed_precision: bool = False
