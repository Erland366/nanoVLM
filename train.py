...
def get_dataloaders(train_cfg, vlm_cfg, *, do_warmup: bool = True):
...
def train(train_cfg, vlm_cfg):
    ...
    if train_cfg.resume_from_checkpoint:
        ...
        if resume_state:
            ...
            resume_run_name = resume_state.get("run_name")
    ...
    run_name = resume_run_name if resume_run_name else get_run_name(train_cfg, vlm_cfg)
...
def main():
    ...
    parser.add_argument('--strict_resume', type=bool, help='Fail if checkpoint is missing expected keys')
